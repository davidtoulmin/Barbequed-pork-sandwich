...
Source.create(name: 'SBS', url: 'http://www.sbs.com.au/news/rss/news/national.xml')
Source.create(name: 'Sydney Morning Herald', url: 'http://www.smh.com.au/rssheadlines/technology-news/article/rss.xml')
Source.create(name: 'The Herald Sun', url: 'http://feeds.news.com.au/heraldsun/rss/heraldsun_news_breakingnews_2800.xml')
